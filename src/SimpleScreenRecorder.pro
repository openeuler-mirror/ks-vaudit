...
DEFINES += SSR_USE_X86_ASM=1 SSR_USE_FFMPEG_VERSIONS=1 SSR_USE_OPENGL_RECORDING=1 SSR_USE_ALSA=1 SSR_USE_PULSEAUDIO=1 SSR_USE_JACK=1 SSR_SYSTEM_DIR=\\"/usr/share/ks-vaudit\\"
